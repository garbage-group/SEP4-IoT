...
void tone_play_starwars()
{
    ...
    tone_play(784, 500);  // G5 for 500 ms D5
    tone_play(784, 500);  // G5 for 500 ms D5
    tone_play(784, 500);  // G5 for 500 ms D5
    tone_play(740, 350);  // F#5 for 350 ms D#5
    tone_play(587, 150);  // D5 for 150 ms B4
    tone_play(523, 500);  // C5 for 500 ms G4
    tone_play(466, 350);  // B4 for 350 ms Eb4
    tone_play(440, 150);  // A4 for 150 ms  B4
    tone_play(392, 1000); // G4 for 1000 ms G4
}

void tone_play_starwars_tuned()
{
